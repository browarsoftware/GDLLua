...
-- http://gdl.org.pl/
-------------------------------- 
require "GDL.ArrayList"
require "GDL.StackToken"
require "GDL.SkeletonData"
require "GDL.SequenceToken"
...
function HipCenter(level)
	return GDLStack:Level(level).Skeleton.HipCenter
end

function Spine(level)
	return GDLStack:Level(level).Skeleton.Spine
end

function ShoulderCenter(level)
	return GDLStack:Level(level).Skeleton.ShoulderCenter
end
